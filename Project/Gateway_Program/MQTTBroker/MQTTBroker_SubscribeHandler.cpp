...
std::vector<char> DecodeSubscribe(std::string msg, SOCKET clientSOCKET){
    ...
    std::cout << ".MQTTserver. Decoding Subscibe Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Decoding Subscibe Message" << std::endl;
    return SendSubAck(subAckMsg);
}

std::vector<char> SendSubAck(std::string subAckMsg){
    std::cout << ".MQTTserver. Sending SubAck Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Sending SubAck Message" << std::endl;
    return byteVector;
}

std::vector<char> DecodeUnsubscribe(std::string msg, SOCKET clientSOCKET){
    
    std::cout << ".MQTTserver. Decoding Unsubscibe Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Decoding Unsubscibe Message" << std::endl;

    return SendUnsubAck(subAckMsg);
}

std::vector<char> SendUnsubAck(std::string subAckMsg){
    std::cout << ".MQTTserver. Sending UnsubAck Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Sending UnsubAck Message" << std::endl;
    return byteVector;
}