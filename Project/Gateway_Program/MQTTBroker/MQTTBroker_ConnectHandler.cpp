...
std::vector<char> DecodeConnect(std::string msg){
    ...
    std::cout << ".MQTTserver. Decoding Connect Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Decoding Connect Message" << std::endl;
    return SendConnAck();
}

std::vector<char> SendConnAck(){

    std::cout << ".MQTTserver. Sending ConnAck Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Sending ConnAck Message" << std::endl;
