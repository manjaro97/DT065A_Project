...
std::vector<char> DecodePublish(std::string msg){
    ...
    std::cout << ".MQTTserver. Decoding Publish Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Decoding Publish Message" << std::endl;
...
std::vector<char> SendPublish(int QoS, std::string topic, std::string body){ 
    ...
    std::cout << ".MQTTserver. Sending Publish Message" << std::endl;
    ...
    std::cout << ".MQTTserver. End of Sending Publish Message" << std::endl;
